...
-- Volcando estructura de calcupost de datos para calcupost
...
-- Volcando datos para la tabla calcupost.migrations: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla calcupost.pulse_aggregates: ~127 rows (aproximadamente)
...
-- Volcando datos para la tabla calcupost.pulse_entries: ~93 rows (aproximadamente)
...
-- Volcando datos para la tabla calcupost.users: ~1 rows (aproximadamente)
